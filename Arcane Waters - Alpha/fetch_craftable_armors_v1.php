<?php
	...
	$query = $mysqli->prepare("SELECT itmId, itmCategory, itmType, crafting_xml_v2.xmlContent as craftingXML, equipment_armor_xml_v3.xmlContent as equipmentXML FROM items 
