...
public class TutorialData3 : MonoBehaviour
{
   ...
   public static List<Tutorial3> tutorials = new List<Tutorial3>() {
      ...
      new List<TutorialStep3>() {
         ...
         new TutorialStep3(TutorialTrigger.MoveShip, "Alright! First, let's move your ship around. Use <#FF8000>[northp]/[westp]/[southp]/[eastp]</color> or <#FF8000>[norths]/[wests]/[souths]/[easts]</color> to move west."),         
