...
public class PrefabSpawner : MonoBehaviour {
   ...
   protected void spawnMaps () {
      ...
      foreach (Map map in maps) {
         ...
         // TODO: Temporary spawn tutorial arrow indicators in all Autogenerated Areas
         GameObject spawnTemp = Instantiate(Minimap.self.tutorialArrowPrefab.gameObject, area.transform);
         spawnTemp.transform.localPosition = Vector3.zero;
