...
public class ClientMessageManager : MonoBehaviour {
   ...
   public static void On_CharacterList (NetworkConnection conn, CharacterListMessage msg) {
      ...
      CharacterScreen.self.initializeScreen(msg.userArray, msg.armorArray, msg.weaponArray, msg.hatArray, msg.armorPalettes1, msg.armorPalettes2, msg.equipmentIds, msg.spriteIds);
   }
