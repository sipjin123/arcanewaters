...
public class SteamUserTest : MonoBehaviour
{
   ...
   public void OnGUI () {
      ...
      if (GUILayout.Button("Part 2 GetEncryptedAppTicket(rgubTicket, 1024, out cubTicket)")) {
      ...
      if (GUILayout.Button("FORCE GET SESSION TICKET")) {
   ...
   void OnGetAuthSessionTicketResponse (GetAuthSessionTicketResponse_t pCallback) {
      D.editorLog("This is the trigger point for creating a ticket.", Color.red);
